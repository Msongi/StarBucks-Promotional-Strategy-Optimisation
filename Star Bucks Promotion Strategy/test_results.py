...
def test_results(promotion_strategy):
    ...
    print('Our irr with this strategy is {:0.4f}.'.format(irr))
    print()
    print('Our nir with this strategy is {:0.2f}.'.format(nir))
    
    print("Starbucks came up with a model with an irr of {} and an nir of {} on the test set.\n\n Summary of findings IRR and NIR:".format(0.0188, 189.45))
    return irr, nir
